...
<div v-loading="saveLoading">
    <el-upload class="image-uploader" ref="upload" :drag="false" :action="ossHost" :data="ossData" :multiple="false" :show-file-list="false" :on-change="onChange" :on-error="onError" :auto-upload="true" :limit="1" :on-success="handleSuccess" :before-upload="beforeUpload">
