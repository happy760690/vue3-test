...
<el-form ref="ruleForm" :model="ruleForm" :rules="rules" label-width="90px" label-position="left">
    ...
    <el-form-item label="选择落地页(请搜索活动名称):" prop="landingPage" class="replace-auto-style" label-width="300">
        <el-select v-model="ruleForm.landingPage" filterable remote reserve-keyword no-match-text="无匹配结果" :loading-text="loadingText" placeholder="" @change="changeLandPage" @focus="getLandingPages" :remote-method="getLandingPages" :loading="landPageLoading">
